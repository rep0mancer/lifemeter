...
public class SubscriptionTracker {
    ...
    public func getSubscriptionCount(for owner: String) -> Int {
        return queue.sync {
            return activeSubscriptions[owner] ?? 0
        }
    }
    ...
    public var totalActiveSubscriptions: Int {
        return queue.sync {
            return activeSubscriptions.values.reduce(0, +)
        }
    }
...
extension Publisher {
    ...
    public func store<T: CancellableStorage>(in storage: T, owner: String? = nil) -> AnyCancellable {
    ...
    public func store<T: CancellableStorage>(
        in storage: T,
        owner: String? = nil,
...
extension AutomaticCleanup where Self: CancellableStorage {
    
    public func setupAutomaticCleanup() {

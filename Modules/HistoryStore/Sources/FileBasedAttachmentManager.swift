    ...
    public func migrateBinaryDataToFiles(context: NSManagedObjectContext) throws {
        ...
        for entry in entries {
            guard let photoData = entry.photoData,
                  ...
                  let calculationId = entry.calculationId else {
                continue
            }
...
extension HistoryEntry {
    ...
    public func setAttachmentImage(_ image: UIImage) throws {
        ...
        do {
            ...
            self.photoData = nil // Clear legacy binary data
        } catch {
    ...
    /// Remove attachment
    public func removeAttachment() throws {
        if let attachmentURL = attachmentURL {
...
extension FileBasedAttachmentManager {
    
    /// Get comprehensive attachment statistics
    public func getAttachmentStatistics() -> AttachmentStatistics {
